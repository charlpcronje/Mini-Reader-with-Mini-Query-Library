Below is all the code to the current app I am working on. It has a few unique factors.
1. src/fx/FX.js
2. src/fx/DOM.js
3. src/fx/boot.js
...
## File: zzz/lit-web-component-files.md
```md
# File Analysis Report
